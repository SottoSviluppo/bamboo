...
class Version20160131002537 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE store (id INT AUTO_INCREMENT NOT NULL, logo_id INT DEFAULT NULL, secondary_logo_id INT DEFAULT NULL, mobile_logo_id INT DEFAULT NULL, header_image_id INT DEFAULT NULL, background_image_id INT DEFAULT NULL, address_id INT DEFAULT NULL, default_language_iso VARCHAR(10) DEFAULT NULL, default_tax_id INT DEFAULT NULL, default_currency_iso VARCHAR(3) DEFAULT NULL, name VARCHAR(255) NOT NULL, leitmotiv VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, is_company TINYINT(1) NOT NULL, cif VARCHAR(255) DEFAULT NULL, tracker VARCHAR(255) DEFAULT NULL, template VARCHAR(255) DEFAULT NULL, routing_strategy VARCHAR(255) NOT NULL, use_stock TINYINT(1) NOT NULL, tax_included TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_FF575877F98F144A (logo_id), UNIQUE INDEX UNIQ_FF5758773C91E28A (secondary_logo_id), UNIQUE INDEX UNIQ_FF5758771925D9BF (mobile_logo_id), UNIQUE INDEX UNIQ_FF5758778C782417 (header_image_id), UNIQUE INDEX UNIQ_FF575877E6DA28AA (background_image_id), INDEX IDX_FF575877F5B7AF75 (address_id), INDEX IDX_FF575877920835C7 (default_language_iso), INDEX IDX_FF575877910402F0 (default_currency_iso), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
