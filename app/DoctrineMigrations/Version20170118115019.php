 ...
 */
class Version20170118115019 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE customer DROP salt');
        $this->addSql('ALTER TABLE permission_groups DROP view_store, DROP view_shipping, DROP view_app_store');
    }
}
