FrontendCore.define('attachment-delete', [], function () {
	return {
		uploader: TinyCore.Module.instantiate('upload-attachment'),
		onStart: function () {

			var aTargets = FrontendTools.getDataModules('attachment-delete'),
				self = this;

			FrontendTools.trackEvent('JS_Libraries', 'call', 'attachment-delete');
