...
class CouponType extends AbstractType {
	...
	public function buildForm(FormBuilderInterface $builder, array $options) {
		$builder
			...
			->add('includeCategories', 'choice', array(
				'required' => false,
				'choices' => [
					ElcodiCouponTypes::INCLUDE_CATEGORY => 'admin.coupon.field.include_categories.options.include_categories',
					ElcodiCouponTypes::EXCLUDE_CATEGORY => 'admin.coupon.field.include_categories.options.exclude_categories',
				],
			))
