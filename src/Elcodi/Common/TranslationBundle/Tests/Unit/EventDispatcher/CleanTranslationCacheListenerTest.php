...
namespace Elcodi\Common\TranslationBundle\Tests\Unit\EventDispatcher;

use Elcodi\Common\TranslationBundle\EventDispatcher\CleanTranslationCacheListener;
...
class CleanTranslationCacheListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDefaultLocale()
    {
        ...
        $storage = $this->getMockBuilder('Elcodi\Common\TranslationBundle\Storage\StorageInterface')
        ...
        $translator = $this->getMock('Elcodi\Common\TranslationBundle\Translation\Translator', array(), array($container, new MessageSelector));
