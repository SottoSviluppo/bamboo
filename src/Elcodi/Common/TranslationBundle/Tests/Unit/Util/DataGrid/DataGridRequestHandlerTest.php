...
namespace Elcodi\Common\TranslationBundle\Tests\Unit\Util\DataGrid;

use Elcodi\Common\TranslationBundle\Manager\LocaleManager;
use Elcodi\Common\TranslationBundle\Tests\Unit\BaseUnitTestCase;
use Elcodi\Common\TranslationBundle\Util\DataGrid\DataGridRequestHandler;
...
class DataGridRequestHandlerTest extends BaseUnitTestCase
{
    ...
    {
        $class = new \ReflectionClass('Elcodi\Common\TranslationBundle\Util\DataGrid\DataGridRequestHandler');
    ...
    {
        $transUnitManagerMock = $this->getMockBuilder('Elcodi\Common\TranslationBundle\Manager\TransUnitManager')
            ->disableOriginalConstructor()
            ->getMock();

        $fileManagerMock = $this->getMockBuilder('Elcodi\Common\TranslationBundle\Manager\FileManagerInterface')
            ->disableOriginalConstructor()
            ->getMock();

        $storageMock = $this->getMockBuilder('Elcodi\Common\TranslationBundle\Storage\StorageInterface')
            ->disableOriginalConstructor()
            ->getMock();
