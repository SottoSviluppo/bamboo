...
namespace Elcodi\Common\TranslationBundle\Tests\Unit\Translation\Manager;
...
class TransUnitManagerTest extends BaseUnitTestCase
{
    ...
    /**
     * @var \Elcodi\Common\TranslationBundle\Storage\DoctrineORMStorage
     */
    private $ormStorage;

    /**
     * @var \Elcodi\Common\TranslationBundle\Storage\DoctrineMongoDBStorage
     */
    private $odmStorage;

    /**
     *
     * @var Elcodi\Common\TranslationBundle\Storage\PropelStorage
     */
    ...
    public function testORMAddTranslation()
    {
        ...
        $class = 'Elcodi\Common\TranslationBundle\Entity\TransUnit';
