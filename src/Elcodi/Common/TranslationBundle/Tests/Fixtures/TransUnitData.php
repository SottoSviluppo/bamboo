...
namespace Elcodi\Common\TranslationBundle\Tests\Fixtures;
...
class TransUnitData implements FixtureInterface
{
    ...
    protected function createTransUnitInstance(ObjectManager $manager)
    {
        ...
        if ($manager instanceof \Doctrine\ORM\EntityManager) {
            $instance = new \Elcodi\Common\TranslationBundle\Entity\TransUnit();
        } elseif ($manager instanceof \Doctrine\ODM\MongoDB\DocumentManager) {
            $instance = new \Elcodi\Common\TranslationBundle\Document\TransUnit();
        }
    ...
    protected function createTranslationInstance(ObjectManager $manager)
    {
        ...
        if ($manager instanceof \Doctrine\ORM\EntityManager) {
            $instance = new \Elcodi\Common\TranslationBundle\Entity\Translation();
        } elseif ($manager instanceof \Doctrine\ODM\MongoDB\DocumentManager) {
            $instance = new \Elcodi\Common\TranslationBundle\Document\Translation();
        }
    ...
    protected function createFileInstance(ObjectManager $manager)
    {
        ...
        if ($manager instanceof \Doctrine\ORM\EntityManager) {
            $instance = new \Elcodi\Common\TranslationBundle\Entity\File();
        } elseif ($manager instanceof \Doctrine\ODM\MongoDB\DocumentManager) {
            $instance = new \Elcodi\Common\TranslationBundle\Document\File();
        }
