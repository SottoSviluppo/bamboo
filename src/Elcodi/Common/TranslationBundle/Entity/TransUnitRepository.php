...
use Elcodi\Common\TranslationBundle\Model\File as ModelFile;
...
class TransUnitRepository extends EntityRepository
{
    ...
    protected function loadCustomHydrator()
    {
        ...
        $config->addCustomHydrationMode('SingleColumnArrayHydrator', 'Elcodi\Common\TranslationBundle\Util\Doctrine\SingleColumnArrayHydrator');
    }
}
